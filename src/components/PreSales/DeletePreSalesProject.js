...
const DeletePreSalesProject = ({
  ...
  return (
    <MISDialog open={openDeletePreSalesProject}>
      <Typography
        variant="h6"
        fontWeight={500}
        textAlign="center"
...
DeletePreSalesProject.propTypes = {
  openDeletePreSalesProject: PropTypes.bool,
  projectId: PropTypes.number,
  refreshView: PropTypes.func,
  handleDeleteProjectDialog: PropTypes.func,
};

export default DeletePreSalesProject;
